...
The compiler in this case will be a tool we use to merge multiple files into a new modality: The new modality can be reflected user stories, Audio/Video Overview, Infographic, a discussion between different entities, and more.
...
My favorite "compiler" for this is NotebookLM. I use it often to digest my docs to image, audio and video, and then consume them. It offers different modalities and setups, and you can select different sources on each generation.
...
2. I copied it to NotebookLM, and requested 3 modalities I like: Infographic, Video Overview, Audio Overview.

As NotebookLM was generating the content, I talked with Claude about what's missing --- the process itself drives my thinking toward criticism.

From these 2 processes, I realized the article was missing 3 items:

1. Visualizing the process with a Live Demo --- this is this section!
2. Risks: Hallucinations, Agent Biases, False confidence, complementary process.
3. Human in the Core: detailing the documentation creation flow.

I corrected them, and promptly added this section --- but it took another 2 iterations (total of 4 versions) to get to this article.

## Now It Is Your Turn

What modalities would you favor? How does that meet your own projects?

I would love to hear in comments, and hear what you think about this concept of Compiler for Documentation as Code.
